...
> **Q**. Call the **summary()** function on your results to get a sense
...
![](Week14_files/figure-commonmark/unnamed-chunk-7-1.png)

> **Q**. Improve this plot by completing the below code, which adds
...
![](Week14_files/figure-commonmark/unnamed-chunk-8-1.png)

> **Q**. Use the **mapIDs()** function multiple times to add SYMBOL,
...
> **Q**. Finally for this section let’s reorder these results by
...
```
    ...
    Info: Working in directory /Users/candicelei/bimm 143/bimm143_github/Week14
...
The pathway with the most significant Entities p-value was cell cycle.
It had an Entities p-value of 2.63E-5. The significant pathways listed
do match my previous KEGG results. The top downregulated KEGG pathway
was also cell cycle, `hsa04110`, p-value of 8.995727e-06. Some factors
that could cause differences between the two methods include using
different pathway databases, pathway definitions, and gene sets. Since
Reactome uses a list of significant genes and KEGG uses fold-change
values, these can lead to differences.
