# Week 6: R functions
Candice Lei (PID: A18585167)
2026-04-16

- [Background](#background)
- [Write your first R function: add()](#write-your-first-r-function-add)
...
- [BLASTp search against nr — are your peptides “unique in
  nature”?](#blastp-search-against-nr--are-your-peptides-unique-in-nature)
...
```
     ...
     [1] 5 1 5 2 1 2 3 2 2 3 3 2 2 5 4 2 4 3 2 3 4 3 1 2 3 5 1 3 2 1 5 1 5 4 2 5 5 2
    [39] 3 2 5 3 1 4 3 1 2 4 4 3 5 4 5 4 4 4 4 1 1 1
...
sequence space (20 L) is still small enough that the known protein
universe has already sampled a lot of those possibilities by chance. For
the longer peptide, it’s not typically always found in nr because it
grows exponentially by 20L. This makes it larger than the total number
of sequences in known proteins.
...
I think the minimum length is around 7-8 amino acids because anything
below that length, the random peptides are too common in the known
protein universe that they aren’t distinctive. It could be a bad design
choice for the immune system to present very short peptides because the
immune system needs peptides that are distinctive to be able to
distinguish self from pathogens. If the presented peptides are too
short, then there wouldn’t be enough information and the chance of false
